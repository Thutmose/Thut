...
public class InventoryPokemon implements IInventory {
    ...
    public final IBeltCapability cap;
    private Container eventHandler;
    public WeakReference<EntityPlayer> player;
    public boolean blockEvents=false;

    public InventoryPokemon(EntityPlayer player) {
        cap = player.getCapability(EventHandlerCommon.BELTAI_CAP, null);
...
//        IBeltCapability cap = player.get().getCapability(EventHandlerCommon.BELTAI_CAP, null);
//        for(int c = 0; c < 6; c++) {
