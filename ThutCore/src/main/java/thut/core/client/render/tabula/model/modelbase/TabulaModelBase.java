...
public class TabulaModelBase extends ModelBase {
    ...
    public void addPart(TabulaRenderer mowzieModelRenderer) {
        if (parts == null) {
            parts = new ArrayList<TabulaRenderer>();
        }
     ...
     */
    public void bob(TabulaRenderer box, float speed, float degree, boolean bounce, float f, float f1) {
     ...
     * @param f1         is the walk speed.
     */
    public void chainFlap(TabulaRenderer[] boxes, float speed, float degree, double rootOffset, float f, float f1) {
     ...
     * @param f1         is the walk speed.
     */
    public void chainSwing(TabulaRenderer[] boxes, float speed, float degree, double rootOffset, float f, float f1) {
        int numberOfSegments = boxes.length;
        float offset = (float) ((rootOffset * Math.PI) / (2 * numberOfSegments));
        for (int i = 0; i < numberOfSegments; i++) {
     ...
     * @param f1         is the walk speed.
     */
    public void chainWave(TabulaRenderer[] boxes, float speed, float degree, double rootOffset, float f, float f1) {
        int numberOfSegments = boxes.length;
        float offset = (float) ((rootOffset * Math.PI) / (2 * numberOfSegments));
        for (int i = 0; i < numberOfSegments; i++) {
     ...
     * @param f1     is the walk speed.
     */
    public void flap(TabulaRenderer box, float speed, float degree, boolean invert, float offset, float weight, float f, float f1) {
        int inverted = 1;
        if (invert) {
            inverted = -1;
        }
     ...
     * @param f1     is the walk speed.
     */
    public void swing(TabulaRenderer box, float speed, float degree, boolean invert, float offset, float weight, float f, float f1) {
        int inverted = 1;
        if (invert) {
            inverted = -1;
        }
     ...
     * @param f1     is the walk speed.
     */
    public void walk(TabulaRenderer box, float speed, float degree, boolean invert, float offset, float weight, float f, float f1) {
        int inverted = 1;
        if (invert) {
            inverted = -1;
        }
