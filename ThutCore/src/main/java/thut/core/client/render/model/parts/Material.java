...
public class Material
{
    ...
    public Material(final String name, final String texture, final Vector3f diffuse, final Vector3f specular, final Vector3f emissive, final float ambient,
            final float shiny, final float transparent)
    {
        this.name = name;
    ...
    public void postRender(final MatrixStack mat, final IVertexBuilder buffer)
    {
        // TODO look into this!
        // if (this.depth && this.transparency > 0)
        ...
        // if (this.emissiveMagnitude != 0 && this.oldLight[0] != -1 &&
        // this.oldLight[1] != -1) GLX.glMultiTexCoord2f(
        // GLX.GL_TEXTURE1, this.oldLight[0], this.oldLight[1]);
    }

    public void preRender(final MatrixStack mat, final IVertexBuilder buffer)
    {
        // TODO look into this!
        ...
        //
        // GL11.glMaterialfv(GL11.GL_FRONT, GL11.GL_AMBIENT,
        // this.makeBuffer(this.ambientIntensity));
        // GL11.glMaterialfv(GL11.GL_FRONT, GL11.GL_DIFFUSE,
        // this.makeBuffer(this.diffuseColor));
        // GL11.glMaterialfv(GL11.GL_FRONT, GL11.GL_SPECULAR,
        // this.makeBuffer(this.specularColor));
        // GL11.glMaterialfv(GL11.GL_FRONT, GL11.GL_SHININESS,
        // this.makeBuffer(this.shininess));
        // GL11.glMaterialfv(GL11.GL_FRONT, GL11.GL_EMISSION,
        // this.makeBuffer(this.emissiveColor));
        //
        ...
        // GLX.glMultiTexCoord2f(GLX.GL_TEXTURE1, 240 * this.emissiveMagnitude,
        // GLX.lastBrightnessY);
        // }
        // else GL11.glEnable(GL11.GL_LIGHTING);
    }
