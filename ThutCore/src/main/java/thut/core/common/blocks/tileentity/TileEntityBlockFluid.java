...
public class TileEntityBlockFluid extends TileEntity
{
    ...
    public int[]     colourArray   = { DEFAULTCOLOUR, DEFAULTCOLOUR, DEFAULTCOLOUR, DEFAULTCOLOUR, DEFAULTCOLOUR,
            DEFAULTCOLOUR };
    public float[][] corner;
    ...
    public void readFromNBT(NBTTagCompound par1)
    {
        ...
        {
            colourArray = new int[] { DEFAULTCOLOUR, DEFAULTCOLOUR, DEFAULTCOLOUR, DEFAULTCOLOUR, DEFAULTCOLOUR,
                    DEFAULTCOLOUR };
        }
    }
