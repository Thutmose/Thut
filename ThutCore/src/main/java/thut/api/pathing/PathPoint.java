...
public class PathPoint extends net.minecraft.pathfinding.PathPoint
{
    public static int makeHash(int x, int y, int z)
    {
        ...
        return i;
        // return y & 255 | (x & 32767) << 8 | (z & 32767) << 24 | (x < 0 ?
        // Integer.MIN_VALUE : 0) | (z < 0 ? 32768 : 0);
    }
    ...
    /** The actual coordinates to path to, this is to indicate which part of the
     * block to path over. */
    public float      x, y, z;
    ...
    /** y & 1023 | (x & 524287) << 10 | (z & 524287) << 28 | (x < 0 ?
     * Integer.MIN_VALUE : 0) | (z < 0 ? 524288 : 0); Returns the linear
     * distance to another path point */
