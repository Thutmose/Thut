...
public class RenderEntity extends MobRenderer<EntityTest, EntityModel<EntityTest>>
{
    ...
    @Override
    protected void preRenderCallback(EntityTest entitylivingbaseIn, MatrixStack matrixStackIn, float partialTickTime)
    {
        // TODO Auto-generated method stub
    ...
    {
        if (entityIn.ticksExisted % 50 > 25)
        {
//             this.entityModel = vanilla;
        }
        else this.entityModel = custom;
        // TODO Auto-generated method stub
