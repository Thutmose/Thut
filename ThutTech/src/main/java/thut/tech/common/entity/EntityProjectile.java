...
public class EntityProjectile extends EntityFallingBlock {
	...
	public EntityProjectile(World p_i45318_1_, double p_i45318_2_,
			double p_i45318_4_, double p_i45318_6_, IBlockState b) {
	...
	public EntityProjectile(World p_i45319_1_, double p_i45319_2_,
			double p_i45319_4_, double p_i45319_6_, IBlockState b,
			int p_i45319_9_) {
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            else if((d<0.04 && fallTime>2 && down.getMaterial().isSolid()) && hit==null)
            	hit = here.copy();
