...
public class BlockDust extends BlockFluid
{
    ...
    {
    	super(par1,getFluidType("dust"),Material.sand);
	...
	{ 
		...
		worldObj.scheduleBlockUpdate(x, y, z, idUp, 5);
			...
			{
				if(Block.blocksList[idUp] instanceof BlockFluid &&metaUp==0)
				{
					worldObj.setBlock(x, y, z, Blocks.worldGen.blockID, 1, 2);
				}
			}
			...
			if(worldObj.getBlockId(x, y, z)==blockID&&!ConfigHandler.deleteAsh)
			{
				worldObj.setBlock(x, y, z, Blocks.inactiveDust.blockID, meta, 2);
			}
		}
