...
public class RenderCuboid {
  ...
  private void tessAddCuboid(Tessellator tessellator, IIcon[] IIcons, double xMin, double zMin, double yMin, double xMax, double zMax, double yMax) {
    ...
    double d0 = (double) IIcons[2].getMinU();
    double d1 = (double) IIcons[2].getMaxU();
    double d3 = (double) IIcons[2].getMinV();
    double d4 = (double) IIcons[2].getMaxV();
    ...
    d3 = (double) IIcons[1].getMinV();
    d4 = (double) IIcons[1].getMaxV();
    ...
    d0 = (double) IIcons[3].getMinU();
    d1 = (double) IIcons[3].getMaxU();
    d3 = (double) IIcons[3].getMinV();
    d4 = (double) IIcons[3].getMaxV();
    ...
    d4 = (double) IIcons[4].getMinV();
    d3 = (double) IIcons[4].getMaxV();
